...
<p align="center">
  <a href="mailto:terrieleon93@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-terrieleon93@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="www.linkedin.com/in/terrie-leong">
    <img src="https://img.shields.io/badge/LinkedIn-terrieleong-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
</p>
...
5. [📬 ¿Trabajamos juntos?](#-trabajamos-juntos)

---

## 🚀 Sobre mí

Enfermera titulada con 7 años de experiencia clínica en sala de operaciones y trayectoria internacional (Perú e Italia).
En transición al área de **Quality Assurance (QA)**, con formación en testing de software y aseguramiento de la calidad.
Aporto una **visión orientada a la seguridad**, el detalle, los procesos y la mejora continua, con especial interés en productos digitales del sector salud.
...
Este proyecto consistio en la validación del backend de **Urban.Grocers**, una plataforma de delivery de comestibles que permite a los usuarios crear kits de productos, gestionar pedidos y coordinar entregas. Estudié la documentación técnica en **Apidoc**, analicé los requisitos de una nueva funcionalidad y diseñé una **lista de comprobación** centrada en flujos de datos y respuestas esperadas.
...
- ✔️ Diseñé **59 casos de prueba**, identificando y reportando **16 errores en JIRA**.
- 🔍 Probé **endpoints en Postman** (GET, POST, PUT, DELETE) y documenté errores en **JIRA**, incluyendo estructura de JSON y respuestas esperadas.
...
- 🧪 Diseñé y ejecuté **54 casos de prueba positivos y negativos**.  
- 🧭 Validé funcionalidades clave en diferentes resoluciones y navegadores.  
- 🐞 Documenté 33 errores funcionales y de interfaz en **JIRA**.
...
<p align="center">
  <a href="docs/CV_QA_TerrieLeon.pdf" target="_blank">
